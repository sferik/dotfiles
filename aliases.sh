...
alias tu='top -o cpu'
alias install_default_gems='rvm exec sh -c "yes | gem install `cat ~/.rvm/gemsets/default.gems`"'
alias update_all_gems='rvm exec sh -c "yes | gem update; yes | gem cleanup"'
